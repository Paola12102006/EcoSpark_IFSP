    ...
    <?php 
        ...
        if (isset($_GET['erro'])) {
            ...
            if ($_GET['erro'] == 'login') {
                ...
                $icone = 'warning';
            } //else if ($_GET['erro'] == 'responsavel') {
                //$mensagem = 'Seu nome não está vinculado a nenhum estudante cadastrado.';
            //}
        ...
        if (isset($_GET['cadastro'])) {
            ...
            } else if ($_GET['cadastro'] == 'sucessoResponsavel') {
        ...
        //     echo "<script>";
        //     echo "Swal.fire({icon: 'success', title: 'Sucesso!', text: " . json_encode($mensagem_sucesso) . ", customClass: {confirmButton: 'btn-sucesso'} });";
        //     echo "</script>";
        // }
                ...
                <form action="./logic/verificar_login.php" method="POST" class="form form-login d-flex">
                    ...
                    <label for="email-login">
                        ...
                        <div class="box-input d-flex">
                            ...
                            <input type="email" id="email-login" name="email-login" placeholder="Digite seu e-mail ou usuário" required>
                        </div>
                    </label>
                ...
                <form action="./logic/cadastrar_user.php" method="post" class="form form-cadastrar d-flex">
                    ...
                    <div class="box-atributos-adicionais d-flex">
                        ...
                        <div class="atributos estudante">
                            <div class="lbls-cadastro d-flex">
                                <label for="serieEscolar" class="label-lado d-flex">
                                    <span>Série</span>
                                    <input type="text" id="serieEscolar" class="inp-estudante" name="serieEscolar">
                                </label>

                                <label for="escola" class="label-lado d-flex">
                                    <span>Escola</span>
                                    <input type="text" id="escola" class="inp-estudante" name="escola">
                                </label>
                            </div>

                            <label for="nomeResponsavel" class="lbl">
                                <span>Nome completo do Responsável</span>
                                <input type="text" id="nomeResponsavel" class="input-txt inp-estudante" name="nomeResponsavel">
                            </label>
                        </div>
                        ...
                        <div class="atributos educador">
                            ...
                            <label for="formacao" class="lbl">
                                <span>Formação</span>
                                <input type="text" id="formacao" name="formacao" class="input-txt inp-educador">
                            </label>

                            <label for="instituicaoEnsino" class="lbl">
                                <span>Instituição</span>
                                <input type="text" id="instituicaoEnsino" name="instituicaoEnsino" class="input-txt inp-educador">
                            </label>

                        </div>

                        <div class="atributos responsavel">

                            <label for="nomeAluno" class="lbl">
                                <span>Nome completo do Aluno</span>
                                <input type="text" id="nomeAluno" name="nomeAluno" class="input-txt inp-responsavel">
                            </label>
